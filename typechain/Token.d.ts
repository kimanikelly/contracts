...
interface TokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "fundAccount()": FunctionFragment;
    "fundAmount()": FunctionFragment;
    ...
    "setFundAmount(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setFundAmount",
    values: [BigNumberish]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "fundAmount", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "increaseAllowance",
    data: BytesLike
  ): Result;
...
export class Token extends BaseContract {
  ...
  functions: {
    ...
    fundAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    fundAccount(overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    fundAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
